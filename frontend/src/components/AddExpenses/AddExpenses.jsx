                ...
                <PopupWrapper>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <FormFields>
                            ...
                            <input id='' name='name' value={formData.name} onChange={handleChange}/>
                        </FormFields>
                        <FormFields>
                        ...
                        <FormFields>
                            ...
                            <input id='' name='amount' value={formData.amount} onChange={handleChange}/>
                        </FormFields>
                        <FormFields>
                        ...
                        <FormFields>
                            ...
                            <input id='' key={formData.id} name='date' className='select-styling' type={'date'}
